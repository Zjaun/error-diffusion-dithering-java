...
public class CustomVideoInputFrameGrabber extends FrameGrabber {
    ...
    public static CustomVideoInputFrameGrabber createDefault(File deviceFile)   throws Exception { throw new Exception(CustomVideoInputFrameGrabber.class + " does not support device files."); }
    public static CustomVideoInputFrameGrabber createDefault(String devicePath) throws Exception { throw new Exception(CustomVideoInputFrameGrabber.class + " does not support device paths."); }
    public static CustomVideoInputFrameGrabber createDefault(int deviceNumber)  throws Exception { return new CustomVideoInputFrameGrabber(deviceNumber); }
    ...
    public static void tryLoad() throws Exception {
        if (loadingException != null) {
            ...
            try {
                ...
                throw loadingException = new Exception("Failed to load " + CustomVideoInputFrameGrabber.class, t);
            }
        }
    }

    public CustomVideoInputFrameGrabber(int deviceNumber) {
    ...
    public void start(int connection) throws Exception {
        ...
        if (format != null && format.length() > 0) {
            ...
            String subTypes[] = {"RGB24", "RGB32", "RGB555", "RGB565", "YUY2", "YVYU", "YUYV", "IYUV", "UYVY",
                    "YV12", "YVU9", "Y411", "Y41P", "Y211", "AYUV", "Y800", "Y8", "GREY", "MJPG", "H264"};
